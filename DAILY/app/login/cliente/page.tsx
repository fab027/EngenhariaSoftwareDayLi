...
export default function ClienteLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false)
      alert("Login de Cliente - Funcionalidade em desenvolvimento")
    }, 1000)
  }
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8">
          ...
          <h1 className="text-3xl font-bold text-white text-center mb-2">Entrar como Cliente</h1>
          <p className="text-gray-400 text-center mb-8">Acesse sua conta e encontre os melhores prestadores</p>
          ...
          <p className="text-center text-sm text-gray-500">
            É um prestador?{" "}
            <Link href="/login/prestador" className="text-purple-400 hover:text-purple-300 transition-colors">
              Clique aqui
            </Link>
          </p>
        </div>
